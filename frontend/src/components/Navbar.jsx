...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between px-6 md:px-[200px] py-4 bg-black text-white  w-full">
    <h1 className="text-lg md:text-xl font-extrabold"><Link to="/">Interview Blogs </Link></h1>
