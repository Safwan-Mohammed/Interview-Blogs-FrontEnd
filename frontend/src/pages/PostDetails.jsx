...
const PostDetails = () => {
  ...
  return (
    <div>
        ...
        <div className="flex " >   <FcManager className=" text-2xl mr-2 text-black" > </FcManager> By {post.username}</div>
        ...
        <img src={IF+post.photo} className="  object-cover h-[45vh] mx-auto mt-8" alt=""/>
         ...
         <div className="flex  justify-center items-center mt-8 space-x-4 font-semibold">
          ...
          {post.categories?.map((c,i)=>(
            <>
            <div key={i} className="bg-gray-300 rounded-lg px-3 py-1 text-black">{c}</div>
            </>
         ...
         <div className="flex justify-center item-center p-3   flex-col mt-4 text-black">
